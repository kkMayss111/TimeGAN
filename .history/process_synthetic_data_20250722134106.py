...
column_names = [
    id,date,transaction_number,city,transaction_value
    'feature_1', 'feature_2', 'feature_3', # Replace with your real feature names
    'city_1', 'city_2', 'city_3', 'city_4', 'city_5' # The one-hot encoded city columns
]

# TODO: Define the name of your original city ID column from the CSV.
original_city_column_name = 'city_id'

# TODO: Define the name of your original date column from the CSV.
...
df_synthetic_denormalized['city_id'] = df_synthetic_denormalized[city_cols].idxmax(axis=1).str.replace('city_', '').astype(int)
