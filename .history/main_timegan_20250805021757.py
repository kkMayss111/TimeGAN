...
#   parser.add_argument(
#       '--data_name',
#       choices=['sine','stock','energy', 'transaction', 'Beirut'],
#       default='Beirut',  # <--- TO THIS
#       type=str)
#   parser.add_argument(
#       '--seq_len',
...
def main (args):
  ...
  pd.DataFrame(reshaped_data).to_csv('{city}_data.csvsynthetic_data.csv', index=False)
  print("Synthetic data saved to synthetic_data.csv")
...
if __name__ == '__main__':  
  ...
  parser.add_argument(
      '--data_name',
      default='Beirut', # Set a default city for easy testing
      type=str)
  # ==============================
